...
/* GPIO Registers */
#define CSR_GPIO_BASE (CSR_BASE + 0x0L)
#define CSR_GPIO_OE_ADDR (CSR_BASE + 0x0L)
#define CSR_GPIO_OE_SIZE 1
#define CSR_GPIO_IN_ADDR (CSR_BASE + 0x4L)
#define CSR_GPIO_IN_SIZE 1
#define CSR_GPIO_OUT_ADDR (CSR_BASE + 0x8L)
...
#define CSR_SPIFLASH_CORE_BASE (CSR_BASE + 0x2000L)
#define CSR_SPIFLASH_CORE_MMAP_DUMMY_BITS_ADDR (CSR_BASE + 0x2000L)
#define CSR_SPIFLASH_CORE_MMAP_DUMMY_BITS_SIZE 1

/* SPIFLASH_CORE Fields */

/* SPIFLASH_PHY Registers */
#define CSR_SPIFLASH_PHY_BASE (CSR_BASE + 0x2800L)
